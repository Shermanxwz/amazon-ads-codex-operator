...
SEALED_TRUE_POLICY_PATHS=('scope.require_independent_verification','scope.require_prewrite_read','scope.require_verified_activation')
...
class OwnerStore:
    ...
    def snapshot(self)->dict[str,Any]:
        ...
        for path in SEALED_TRUE_POLICY_PATHS:_deep_set(effective,path,True)
    ...
    def _sanitize_policy(policy:dict[str,Any])->dict[str,Any]:
        ...
        for path in SEALED_TRUE_POLICY_PATHS:_deep_set(p,path,True)
