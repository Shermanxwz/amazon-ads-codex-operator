...
def main():
    ...
    if role=="planner":
        ...
        output({"context":{"today_spend":1.0,"today_spend_observed_at":now,"today_spend_evidence_ref":"virtual:spend","active_campaign_budget_total":10.0,"observed_asins":["B000VIRTUAL"]},"summary":"virtual acceptance bid update","learning_snapshot":{"observed_at":now,"entities":[],"economics":[],"portfolio_candidates":[],"experiments":[]},"actions":[{"action_id":"virtual-bid","action_type":"update_bid","tool_name":"updateKeywords","ad_product":"SPONSORED_PRODUCTS","entity_type":"keyword","entity_id":"k1","arguments":{"keywordId":"k1","field":"bid","bid":after},"before":{"bid":before},"after":{"bid":after},"spend_delta":0.0,"confidence":0.95,"evidence_refs":["virtual:keyword:k1"],"dependencies":[],"reversible":True,"rollback":{"bid":before},"prewrite_observed_at":now,"rationale":"sealed full-stack acceptance"}]}); return 0
